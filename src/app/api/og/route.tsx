        ...
        >
          ...
          <div
            style={{
              ...
              bottom: 0,
              opacity: 0.1,
              backgroundImage: 'radial-gradient(#ff7a00 2px, transparent 2px)',
          ...
          <div style={{ display: 'flex', width: '100%', justifyContent: 'space-between', marginBottom: '20px' }}>
            <div style={{ color: '#ff7a00', fontSize: '24px', fontWeight: 'bold' }}>MM_TERMINAL.v1</div>
          ...
          >
            <div style={{ color: '#ff7a00', fontSize: '18px', marginBottom: '10px' }}>// ALPHA_SIGNAL_REPORT</div>
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                <div style={{ 
                    ...
                    border: `2px solid ${signal === 'BULLISH' ? '#00ff00' : '#ff7a00'}`,
                    color: signal === 'BULLISH' ? '#00ff00' : '#ff7a00',
                    padding: '5px 15px',
                    fontSize: '24px',
                    fontWeight: 'bold'
                }}>
          ...
          {/* Corner Accents */}
          <div style={{ position: 'absolute', top: '20px', left: '20px', width: '30px', height: '30px', borderTop: '4px solid #ff7a00', borderLeft: '4px solid #ff7a00' }} />
          <div style={{ position: 'absolute', top: '20px', right: '20px', width: '30px', height: '30px', borderTop: '4px solid #ff7a00', borderRight: '4px solid #ff7a00' }} />
        </div>
      ) as any,
      {
        width: 1200,
