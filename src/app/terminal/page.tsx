...
export default function TerminalDashboard() {
  ...
  return (
    <main className="scanlines min-h-screen bg-black text-white font-mono selection:bg-[#ff7a00] selection:text-black">
      ...
      {/* Top Navigation Bar */}
      <nav className="sticky top-0 z-40 flex items-center justify-between border-b border-[#ff7a00] bg-black/90 px-6 py-3 backdrop-blur-sm">
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="hidden items-center gap-2 text-xs text-[#ff7a00] md:flex animate-pulse">
            <Activity className="h-4 w-4" />
            LIVE FEED
          </div>
          <Link href="/settings" className="border border-[#333] p-2 hover:border-[#ff7a00] hover:text-[#ff7a00] transition-colors">
      ...
      <div className="mx-auto grid max-w-[1400px] grid-cols-1 gap-6 p-6 md:grid-cols-12 md:p-8">
        ...
        <div className="flex flex-col gap-6 md:col-span-3">
          ...
          <section className="border border-[#ff7a00] bg-[#110000] p-4 relative overflow-hidden group min-h-[100px]">
            <div className="absolute inset-0 bg-gradient-to-b from-[#ff7a0010] to-transparent pointer-events-none"></div>
            
            <div className="flex items-center gap-2 mb-3">
              <div className="h-1.5 w-1.5 bg-[#ff7a00] animate-ping"></div>
              <h3 className="text-[10px] font-bold tracking-[0.2em] text-gray-400 uppercase" suppressHydrationWarning>
                System_Report_{reportDate}
              </h3>
            </div>
            <div className="relative z-10 text-xs text-gray-300 font-mono leading-relaxed whitespace-pre-line border-l border-[#ff7a0040] pl-3 italic">
              {isBriefLoading ? (
          ...
          <section className="border border-[#ff7a00] bg-[#110000]">
            <div className="flex items-center gap-2 border-b border-[#ff7a00] bg-[#ff7a00] px-3 py-2 text-black font-bold tracking-widest text-sm">
              ...
              {topNews ? (
                <>
                  <div className="mb-2 flex items-center justify-between text-[10px] text-gray-400">
                    ...
                    <span className="text-[#ff7a00]">IMPACT: {topNews.aiRating?.score || "N/A"}</span>
                  </div>
                  ...
                  <div className="space-y-2 text-xs">
                    <div className="flex justify-between border-b border-[#333] pb-1">
                      ...
                      <span className={`font-bold uppercase ${topNews.aiRating?.signal === 'long' ? 'text-green-500' : 'text-[#ff7a00]'}`}>
          ...
          <section className="border border-[#333] bg-black shadow-[0_0_10px_rgba(255,0,0,0.05)]">
            <div className="flex items-center justify-between border-b border-[#333] px-3 py-2 text-white bg-[#111] tracking-widest text-sm">
              <div className="flex items-center gap-2">
                <Video className="h-4 w-4 text-[#ff7a00] animate-pulse" />
                <h2>LIVE_UPLINK (GLOBAL_MATRIX)</h2>
              </div>
              <span className="text-[9px] bg-[#ff7a00] text-black px-1 font-bold animate-pulse">REC</span>
            </div>
            ...
            >
              ...
              {/* HUD corner markers */}
              <div className="absolute top-3 left-3 w-5 h-5 border-t-2 border-l-2 border-[#ff7a00] z-20 pointer-events-none"></div>
              <div className="absolute top-3 right-3 w-5 h-5 border-t-2 border-r-2 border-[#ff7a00] z-20 pointer-events-none"></div>
              <div className="absolute bottom-3 left-3 w-5 h-5 border-b-2 border-l-2 border-[#ff7a00] z-20 pointer-events-none"></div>
              <div className="absolute bottom-3 right-3 w-5 h-5 border-b-2 border-r-2 border-[#ff7a00] z-20 pointer-events-none"></div>
            ...
            <div className="bg-[#0a0a0a] p-2 flex justify-between items-center text-[9px] text-gray-500 border-t border-[#333]">
               ...
               <span className="uppercase text-[#ff7a00]">NET_LATENCY: 24MS</span>
            </div>
          </section>
          ...
          <section className="flex h-[600px] flex-col border border-[#333] bg-black">
            ...
            <div className="flex-1 divide-y divide-[#222] overflow-y-auto p-4 custom-scrollbar">
              {isLoading && newsFeed.length === 0 ? (
                <div className="h-full flex flex-col items-center justify-center text-[#ff7a00] space-y-4">
                ...
                newsFeed.map((news) => (
                  <article key={news.id} className="py-4 first:pt-0 hover:bg-[#050505] transition-colors group">
                    <div className="mb-2 flex items-center justify-between text-[10px]">
                      ...
                      {news.aiRating?.score && (
                        <span className="border border-[#ff7a00] text-[#ff7a00] px-1 font-bold">
                    ...
                    <div className="flex flex-wrap gap-2 mt-2">
                      {news.aiRating?.signal && news.aiRating.signal !== 'neutral' && (
                        <span className={`bg-[#111] border border-[#333] px-1 py-0.5 text-[9px] uppercase ${news.aiRating.signal === 'long' ? 'text-green-500' : 'text-[#ff7a00]'}`}>
                          {news.aiRating.signal}
                        </span>
                      )}
                      {news.coins?.map(coin => (
                        <Link href={`/asset/${coin.symbol.toLowerCase()}`} key={coin.symbol} className="bg-[#111] border border-[#ff7a00] px-1 py-0.5 text-[9px] text-[#ff7a00] font-bold hover:bg-[#ff7a00] hover:text-black transition-colors cursor-pointer">
                          ${coin.symbol}
                        </Link>
                      ))}
                      <span className="bg-[#111] border border-[#ff7a00] px-1 py-0.5 text-[9px] text-[#ff7a00] font-bold">
        ...
        <div className="flex flex-col gap-6 md:col-span-3">
          ...
          <section className="border border-[#333] bg-black">
            <div className="flex items-center gap-2 border-b border-[#333] px-3 py-2 text-white bg-[#111] tracking-widest text-sm">
              <Crosshair className="h-4 w-4 text-[#ff7a00]" />
              <h2>VIRAL RADAR</h2>
            </div>
                  ...
                  >
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      {anomaly.status === "VIRAL_ANOMALY" && (
                        <span className="bg-[#ff7a00] text-black text-[9px] font-black px-1 animate-pulse">
                          ANOMALY
                        </span>
                      )}
                    </div>
              ...
              <ul className="space-y-3 font-mono text-xs">
                {topMentions.length > 0 ? topMentions.map((mention, idx) => (
                  <li key={idx} className="flex items-center justify-between border-b border-[#222] pb-2 last:border-0 last:pb-0 group">
                    <Link href={`/asset/${mention.symbol.toLowerCase()}`} className="flex items-center gap-2 hover:text-[#ff7a00] transition-colors">
                      <span className="text-[#ff7a00] opacity-50 text-[10px]">0{idx + 1}</span>
          ...
          <div className="flex-1 border border-[#333] bg-dither p-4 flex items-end justify-end opacity-50 hidden md:flex min-h-[100px]">
             <div className="text-right">
                <div className="text-[#ff7a00] text-[10px] tracking-widest">SYS.OP.NORMAL</div>
      ...
      <div className="mx-auto max-w-[1400px] p-6 md:p-8">
        <section className="border border-[#333] bg-black overflow-hidden shadow-[0_0_30px_rgba(255,0,0,0.05)]">
          <div className="flex items-center gap-2 border-b border-[#333] px-4 py-3 text-white bg-[#0a0a0a] tracking-[0.3em] text-sm font-bold border-l-4 border-l-[#ff7a00]">
            <Cpu className="h-4 w-4 text-[#ff7a00]" />
          ...
          <div className="p-8 space-y-16">
            ...
            <div className="relative">
              <div className="absolute -top-4 left-6 bg-black px-3 py-1 border border-[#ff7a00] text-[10px] text-[#ff7a00] font-black z-10 tracking-[0.2em]">
              ...
              <div className="border border-[#333] p-10 bg-[#020202] relative overflow-hidden">
                ...
                <div className="relative z-10 flex flex-col items-center">
                  ...
                  {/* UI Layer */}
                  <div className="w-full max-w-2xl border border-[#ff7a00] bg-black p-4 mb-12 relative shadow-[0_0_15px_rgba(255,0,0,0.1)]">
                    <div className="text-[10px] text-[#ff7a00] font-bold mb-3 border-b border-[#ff7a0020] pb-1 uppercase tracking-widest">USER_INTERFACE [MM_SYS]</div>
                  ...
                  <div className="flex justify-around w-full max-w-2xl px-10 -mt-12 mb-4">
                    <div className="h-8 w-px bg-gradient-to-b from-[#ff7a00] to-[#333]"></div>
                    <div className="h-8 w-px bg-gradient-to-b from-[#ff7a00] to-[#333]"></div>
                    <div className="h-8 w-px bg-gradient-to-b from-[#ff7a00] to-[#333]"></div>
                  </div>
                  ...
                  <div className="w-full max-w-4xl grid grid-cols-4 gap-6 mb-12 uppercase">
                    {[
                      ...
                      <div key={api.path} className="group relative border border-[#333] bg-[#050505] p-3 text-center hover:border-[#ff7a00] transition-all duration-300">
                        <div className="absolute -top-1 -right-1 h-2 w-2 bg-[#ff7a00] opacity-20 group-hover:opacity-100 transition-opacity"></div>
                        <div className="text-[7px] text-gray-600 mb-1 tracking-[0.2em] group-hover:text-[#ff7a00]">REST_ENDPOINT</div>
                  ...
                  <div className="flex justify-center w-full max-w-4xl -mt-12 mb-6">
                    <div className="h-12 w-px bg-gradient-to-b from-[#333] via-[#ff7a00] to-[#ff7a00]"></div>
                  </div>

                  {/* Neural Core Layer - Pulsing High-End Core */}
                  <div className="w-full max-w-2xl border-2 border-[#ff7a00] p-1 bg-black relative group shadow-[0_0_30px_rgba(255,0,0,0.1)]">
                    <div className="border border-[#ff7a0040] p-6 bg-[#0a0000] relative overflow-hidden">
                      ...
                      <div className="relative z-10">
                        <div className="text-[12px] text-[#ff7a00] font-black tracking-[0.6em] mb-6 text-center uppercase crt-flicker">NEURAL_INFRASTRUCTURE_V1</div>
            ...
            <div className="border-t border-[#333] pt-12 space-y-12">
              ...
              <div className="relative group">
                <div className="absolute -inset-1 bg-gradient-to-r from-[#ff7a0030] to-transparent blur opacity-25 group-hover:opacity-50 transition-opacity"></div>
                <div className="relative flex items-end justify-between border-b border-[#ff7a00] pb-4">
                  <div>
                    <div className="flex items-center gap-2 mb-2">
                      <span className="h-1 w-8 bg-[#ff7a00]"></span>
                      <span className="text-[10px] text-[#ff7a00] font-black tracking-[0.5em] uppercase">SYSTEM_MANIFESTO</span>
                    </div>
                    <h3 className="text-3xl font-black text-white tracking-tighter uppercase italic leading-none">
                      THE <span className="text-[#ff7a00]">MISSION</span>
                    </h3>
                  </div>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
                ...
                <div className="lg:col-span-8 space-y-8">
                  <div className="relative">
                    <p className="text-lg md:text-xl font-bold text-white leading-relaxed tracking-tight border-l-4 border-[#ff7a00] pl-6 py-2 uppercase">
                      HELIOS is an <span className="text-[#ff7a00]">autonomous neural system</span> quantifying market uncertainty by mapping the structural dynamics of crypto-driven markets.
                    </p>
                    <div className="mt-8 grid grid-cols-1 md:grid-cols-2 gap-6">
                       <div className="bg-[#050505] border border-[#111] p-4 hover:border-[#ff7a0030] transition-colors">
                          <span className="text-[#ff7a00] text-[10px] font-black block mb-2 tracking-widest">// RAW_DATA_INTERCEPT</span>
                          <p className="text-xs text-gray-400 leading-relaxed italic">
                            Constructing actionable signals through real-time news aggregation, anomaly detection, and advanced AI analysis.
                          </p>
                       </div>
                       <div className="bg-[#050505] border border-[#111] p-4 hover:border-[#ff7a0030] transition-colors">
                          <span className="text-[#ff7a00] text-[10px] font-black block mb-2 tracking-widest">// REGIME_SHIFT_DETECTION</span>
                          <p className="text-xs text-gray-400 leading-relaxed italic">
                ...
                <div className="lg:col-span-5 relative">
                  ...
                  <div className="space-y-4">
                    <div className="text-[11px] font-black text-[#ff7a00] mb-6 tracking-[0.3em] flex items-center gap-2">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      {[
                        ...
                        <div key={i} className="group relative bg-[#080808] border border-[#111] p-3 hover:border-[#ff7a0040] transition-colors">
